  ...
  return (
    <>
      <div
        className="card"
        style={
          props.details.host.includes(search) &&
          savedEvent.find(
            (event) =>
              event.host === props.details.host &&
              event.event === props.details.event
          ) !== undefined
            ? {}
            : hideStyle
        }
        ...
        <div className="primaryCard">
          ...
          <div className="item2">
            <Tooltip title={props.details.host} arrow>
              <Link href={`https://www.${props.details.host}`} target="_blank">
                <img
                  src={
                    "https://logo.clearbit.com/" + config(props.details.host)
                  }
                  onError={(e) => {
          ...
          <div className="item3">
            <p>
              {props.started
                ? "End: " + setDate(props.details.end)
                : "Start: " + setDate(props.details.start)}
            </p>
          </div>
          ...
          <div className="item4">
            <Tooltip title="Duration" placement="left" arrow>
              <p>
                ...
                {days
                  ? days + " days"
                  : new Date(props.details.duration * 1000)
                      .toISOString()
                      .substr(11, 5)}
              </p>
            </Tooltip>
          ...
          <div className="item5">
            <Tooltip title="Time Left" placement="left" arrow>
              <p>
                ...
                <Timer
                  start_end={
                    props.started ? props.details.end : props.details.start
                  }
                />
              </p>
            </Tooltip>
